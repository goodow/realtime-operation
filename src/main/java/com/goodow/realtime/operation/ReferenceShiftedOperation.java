...
public class ReferenceShiftedOperation implements Operation<Void> {
  ...
  @Override
  public ReferenceShiftedOperation composeWith(Operation<Void> op) {
  ...
  public Pair<? extends Operation<Void>, ? extends Operation<?>> transformWith(Operation<?> clientOp) {
    ...
    return Pair.of(NoOp.<Void> get(), new ReferenceShiftedOperation(referencedObject, op.newIndex,
        canBeDeleted, newIndex));
  }
}
